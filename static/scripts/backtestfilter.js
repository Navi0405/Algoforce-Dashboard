...
$("#date_filter").on('click', async function() {
    ...
    // Collect the values of checked checkboxes for coins
    let checkedAccounts = [];
    let accounts_list = 'your_account,your_account,your_account,your_account,your_account,your_account,your_account';
    ...
    // let coins_list = 'UNIUSDT,AVAUSDT,LINKUSDT,XRPUSDT,ETHUSDT,BNBUSDT,SOLUSDT,symbol,LTCUSDT,MATICUSDT,ADAUSDT,BTCUSDT';
    // if (checkedCoin === 'ALL') {
