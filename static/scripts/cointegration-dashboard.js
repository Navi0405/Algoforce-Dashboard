import { updateNavigationData1, updateNavigationData2 } from './your_file-navigation.js';
...
//         item.your_accountx_account === 'your_account'
//       );
//       const your_accountData = dataToFilter.filter(item => 
//         item.your_accountx_account === 'your_account'
//       );
...
//       // Now use the filtered data for your_accountx_account
...
function calculateNegativePnl(data) {
    ...
    data.forEach(item => {
        ...
        // Rename "your_account" to "ALL ACCOUNTS"
        let account = item.your_accountx_account === "your_account" ? "ALL ACCOUNTS" : item.your_accountx_account;
