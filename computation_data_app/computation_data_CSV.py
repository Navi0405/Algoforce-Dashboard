...
async def data_computations(cached_data, start_date, end_date, your_account_accounts, calculation_types, symbols):
    ...
    try:
        ...
        # df.to_csv(r"..path/\to/\your/\your/\jonathan-dashboard\PINAKA_LATEST\file/\storage\data.csv", index=False)
...
async def value():
    ...
    result = await data_computations(cached_data, start_date, end_date, your_account_account, calculation_types, symbols)
