"""
URL configuration for your_dashboard project.
...
urlpatterns = [
    ...
    path('your_file-dashboard/', TemplateView.as_view(template_name='home/your_file-dashboard.html')),
...
# urlpatterns += static('/models/', document_root=os.path.abspath(r"..\file/\backtest_implementation_ninja\validate_trades\models\symbol\symbol_P0501\symbol_115"))